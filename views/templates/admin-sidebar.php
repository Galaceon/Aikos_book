<aside class="dashboard__sidebar">
    <a href="/admin/dashboard" class="dashboard__enlace <?php echo pagina_actual('/dashboard') ? 'dashboard__enlace-actual' : ''; ?>">
        <span class="dashboard__sidebar-icon material-symbols-outlined" translate="no">dashboard</span>
    ...
    <a href="/admin/reviews" class="dashboard__enlace <?php echo pagina_actual('/reviews') ? 'dashboard__enlace-actual' : ''; ?>">
        <span class="dashboard__sidebar-icon material-symbols-outlined" translate="no">reviews</span>
    ...
    <a href="/admin/users" class="dashboard__enlace <?php echo pagina_actual('/users') ? 'dashboard__enlace-actual' : ''; ?>">
        <span class="dashboard__sidebar-icon material-symbols-outlined" translate="no">groups</span>
...
<aside class="dashboard__sidebar--mobile">
    ...
    <form method="POST" action="/logout" class="dashboard__enlace">
        <label for="cerrar_sesion" class="dashboard__sidebar--mobile__label"><span class="barra__search-img material-symbols-outlined" translate="no">login</span></label>
